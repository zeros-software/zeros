      ...
      <defs>
        ...
        <mask id="logoMask">
          <path
            ...
            fill="white"
          />
          <path d={LOGO_PATHS.slash} fill="white" />
        </mask>
      </defs>
      <rect
        width="400"
        height="400"
        filter="url(#logoNoise)"
        mask="url(#logoMask)"
        fill="white"
      />
    </svg>
